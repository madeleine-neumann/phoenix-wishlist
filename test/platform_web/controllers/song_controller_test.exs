defmodule PlatformWeb.SongControllerTest do
  use PlatformWeb.ConnCase

  alias Platform.Core

  @create_attrs %{archived: true, band: "some band", performer_name: "some performer_name", title: "some title"}
  ...
  def fixture(:song) do
    {:ok, song} = Core.create_song(@create_attrs)
    song
  end
  ...
  describe "update song" do
    ...
    test "redirects when data is valid", %{conn: conn, song: song} do
      ...
      assert html_response(conn, 200) =~ "some updated band"
    end
